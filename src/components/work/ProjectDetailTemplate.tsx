    ...
    <>
      <section className="bg-thynkteck-black pt-40 pb-16 sm:pt-48">
        <div className="container mx-auto px-4 sm:px-6 max-w-3xl">
          ...
          <h1 className="text-page font-bold text-white mb-4">
            {project.title}
          </h1>
          <p className="text-body-lg text-white/70">{project.summary}</p>
        </div>
      </section>
      ...
      <section className="bg-thynkteck-soft-black py-20 sm:py-28">
        <div className="container mx-auto px-4 sm:px-6 grid grid-cols-1 md:grid-cols-3 gap-5">
          <BentoCard>
            <h3 className="text-thynkteck-blue text-caption font-semibold uppercase mb-2">Challenge</h3>
            <p className="text-white/80 text-caption">{project.challenge}</p>
          </BentoCard>
          <BentoCard>
            <h3 className="text-thynkteck-blue text-caption font-semibold uppercase mb-2">Approach</h3>
            <p className="text-white/80 text-caption">{project.approach}</p>
          </BentoCard>
          <BentoCard>
            <h3 className="text-thynkteck-blue text-caption font-semibold uppercase mb-2">Result</h3>
            <p className="text-white/80 text-caption">{project.result}</p>
          </BentoCard>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="flex flex-wrap gap-3">
            {project.techStack.map((tech) => (
              <span key={tech} className="px-4 py-2 rounded-full border border-white/10 text-white/70 text-nav">
                {tech}
              </span>
            ))}
          </div>
      ...
      <section className="bg-thynkteck-black py-16 sm:py-20">
        <div className="container mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div>
            <span className="text-white/50 text-caption">Next project</span>
            <h3 className="text-subhead font-semibold text-white">{nextProject.title}</h3>
          </div>
